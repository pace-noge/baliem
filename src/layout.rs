...
pub static LAYERS: keyberon::layout::Layers = &[
    &[
        ...
        &[Trans,             k(LAlt),    Trans,              k(LGui), Trans,           k(Space),     Trans,       Trans,       Trans,       k(RGui),     k(RAlt),  Trans,           Trans,              Trans,               Trans            ],
    ], &[
        ...
        &[d(0),     d(1),     k(NumLock),   Trans,        k(Escape),   Trans,             Trans,       Trans,       k(Left),k(Down),     k(Left),  k(Down),    k(Up),         k(Right),       Trans             ],
